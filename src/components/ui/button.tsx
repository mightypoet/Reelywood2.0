...
function LiquidButton({
  ...
  const backgrounds = (
    <>
      ...
      <div
        className="absolute top-0 left-0 isolate -z-20 h-full w-full overflow-hidden rounded-md"
  ...
  if (asChild && React.isValidElement(children)) {
    return React.cloneElement(children as React.ReactElement<any>, {
      ...props,
      className: cn(wrapperClassName, (children.props as any).className),
      children: (
        <>
          {backgrounds}
          <div className="pointer-events-none z-10 w-full h-full flex justify-center items-center gap-2">
